...
class App {
  ...
  constructor() {
    ...
    this.beforeInit();
    setTimeout(() => {
      document.getElementById("main").removeChild(this.renderer.domElement);
      this.constructorFuncs();
    }, 2000);
    // this.addGUI();
  }
  ...
  beforeInit(){
    ...
    this.renderer.domElement.style.background = 'rgb(4, 27, 54)';
